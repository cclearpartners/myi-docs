...
| tableTextAlign      | Array | Sets text alignment in table columns. Comma-separated list of of pairs: `tableTextAlign:NUMBER/center,STRING/right;` will center-align all number fields and right-align all string fields. Types are: BOOLEAN, CURRENCY, DATE, DATETIME, DOUBLE, INTEGER, NUMBER, PERCENT, PICKLIST, STRING and TEXTAREA. Alignment can be left, center or right. |
